...
/*getData(calendar+'?&origin=SVX&destination=KGD&depart_date=2020-05-25&one_way=true&token='+apiKey, (data)=>{
...
/*const arr=['Максим', 'Степан','Андрей','Александр','Сергей','Илья','Саня','Гоша','Феофан'];

const name=arr.sort((a,b)=>{
    if(a<b) return -1;
    if(a>b) return 1;
    return 0;
});
